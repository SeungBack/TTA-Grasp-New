...
from models.ptv3 import PTv3GraspQNet
...
def train(cfgs):
    ...
    if cfgs.net == 'pointnet2':
        ...
        net = PTv3GraspQNet(in_channels=3)
    else:
    ...
    log_string('Number of parameters: {}M'.format(sum([p.numel() for p in net.parameters()])/126), log_dir)
