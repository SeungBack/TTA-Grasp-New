...
#             nn.Dropout(dropout),
#             nn.Linear(256, num_classes)  # logits (no Sigmoid here)
#         )
...
#         logits = self.score_head(fused)                                    # [B, num_classes]
#         return logits
...
#         preds = []
#         for _ in range(N):
#             logits = self.score_head(fused)         # [B,1]
#             # score = torch.sigmoid(logits)           # prob
#             preds.append(logits)
