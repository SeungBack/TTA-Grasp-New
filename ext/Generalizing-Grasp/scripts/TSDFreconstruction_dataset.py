...
for scene_id in tqdm(range(101,190)):
    scene_path = os.path.join(root,"scenes",'scene_{}'.format(str(scene_id).zfill(4)),camera_name)
    save_path = os.path.join(root, "fusion_scenes",'scene_{}'.format(str(scene_id).zfill(4)),camera_name)
