...
parser.add_argument('--dataset_root', default='/home/seung/Workspaces/Datasets/GraspClutter6D', help='the root of the GraspNet dataset')
...
if __name__ == '__main__':
    ...
    for scene_id in tqdm(range(9, 100)):
