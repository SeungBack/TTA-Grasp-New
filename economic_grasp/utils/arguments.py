...
parser.add_argument('--angle_loss_weight', type=float, default=0.5, help='Loss weight of the angle term')
...
parser.add_argument('--width_loss_weight', type=float, default=100, help='Loss weight of the width term')
